...
- `layer34,last1` was the first learned handoff site that generalized on held-out prompts.

## Canonical report artifacts

- `decision_memo.md`
- `targeted_site_report.md`
- `targeted_site_rows.csv`
- `targeted_site_summary.json`
